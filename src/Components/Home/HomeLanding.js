...
const HomeLanding = () => {
  return (
      <section className='w-full h-auto -mt-20'>
        <article className='w-full h-1000px flex justify-center items-center bg -mt-36 screen1050px:h-auto screen1050px:mb-20 screen420px:mt-0 screen420px:pt-5'>
          <div className='w-1300px h-500px flex screen1050px:w-full screen1050px:grid screen1050px:h-auto'>
            <div className='w-full h-auto grid'>
              <div className='w-full h-3/5 flex justify-start items-center px-5 screen1050px:h-auto screen1050px:mb-10 screen1050px:mt-56 screen850px:mt-40 screen420px:mb-0 screen420px:mt-26'>
                <p className='text-7xl drop-shadow-0_7_3_rgaba_black_1 text-white font-bold leading-tight screen530px:text-6xl screen530px:leading-snug screen420px:text-3xl'>
            ...
            <div className='w-full h-auto flex justify-center items-end'>
              <div className='relative w-full h-300px flex justify-center items-center p-6 mb-16 screen1050px:h-auto'>
                ...
                <div className='w-full h-full bg-rgba_white_05 rounded-xl pb-5'>
                  <p className='text-right text-white drop-shadow-0_5_10_rgaba_black_8 text-xl px-5 mt-5 screen1050px:text-left screen1050px:mt-10'>
                  ...
                  <p className='text-right text-2xl font-bold mt-10 text-white drop-shadow-0_5_10_rgaba_black_8 px-5 screen1050px:text-left'>
                    Suraida F. Muksin
                  </p>

                  <p className='text-right text-base font-semibold text-white drop-shadow-0_5_10_rgaba_black_8 px-5 screen1050px:text-left'>
                    Mayor, Municipality of Mapun
                  </p>
                </div>
                <span className='absolute right-0 -bottom-14 text-9xl text-white drop-shadow-0_5_10_rgaba_black_8 screen420px:text-7xl screen420px:-bottom-5 screen420px:right-2'>❞</span>
              </div>
            </div>
          </div>
        </article>
