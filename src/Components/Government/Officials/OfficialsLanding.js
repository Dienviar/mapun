...
const OfficialsLanding = () => {
  return (
    <section className='w-full h-auto flex justify-center px-3 mt-10'>
        <article className='w-1000px h-auto'>
            <div className='w-full h-auto flex items-center'>
                <p className='text-4xl text-blue font-bold'>Government Officials</p>
            </div>
...
export default OfficialsLanding